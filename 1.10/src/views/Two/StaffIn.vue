    ...
    <el-card class="box-card">
      <div class="box">
        ...
        <div class="right">
          ...
          <el-button size="mini" type="success" @click="$router.push('/uploading')">excel导入</el-button>
    ...
    <el-card class="box-card" style="margin-top: 10px">
      <el-table :data="tableData" style="width: 100%" border>
        ...
        <el-table-column prop="address" label="操作" sortable width="300" fixed="right">
          <template slot-scope="scope">
            <div class="btn">
              <span @click="$router.push({ name: 'check', params: { id: scope.row.id } })">查看</span>
              <span>转正</span>
              <span>调岗</span>
              <span>离职</span>
              <span>角色</span>
              <button style="color: gray; border: none; font-size: 14px" disabled>删除</button>
            </div>
          </template>
        </el-table-column>
      </el-table>
