  ...
  <div class="about">
    <el-container>
      ...
      <el-aside :width="isCollapse ? '60px' : '180px'">
        <el-menu active-text-color="#fff" background-color="#4474fa" default-active="1" text-color="#fff" router>
          <div class="img">
            <img
              ...
              alt=""
              :width="isCollapse ? '60px' : '140px'"
            />
          </div>
          <el-menu-item index="/userIndex" @click="addNav('userIndex', '首页')">
            <span><i class="el-icon-tickets"></i>首页</span>
          </el-menu-item>
          <el-menu-item index="/StaffIn" @click="addNav('StaffIn', '员工')">
            <span><i class="el-icon-user"></i>员工</span>
          </el-menu-item>
          <el-menu-item index="/setup" @click="addNav('setup', '设置')">
            <span><i class="el-icon-setting"></i>设置</span>
          </el-menu-item>
          <el-menu-item index="/Permission" @click="addNav('Permission', '权限管理')">
            <span><i class="el-icon-lock"></i>权限管理</span>
          </el-menu-item>
          <el-menu-item index="/security" @click="addNav('security', '社保')">
            <span><i class="el-icon-present"></i>社保</span>
          </el-menu-item>
          <el-menu-item index="/Approval" @click="addNav('Approval', '审批')">
            <span><i class="el-icon-files"></i>审批</span>
          </el-menu-item>
          <el-menu-item index="/attendance" @click="addNav('attendance', '考勤')">
            <span><i class="el-icon-money"></i>考勤</span>
          </el-menu-item>
          <el-menu-item index="/wages" @click="addNav('wages', '工资')">
            <span><i class="el-icon-lollipop"></i>工资</span>
          </el-menu-item>
          <el-menu-item index="/structure" @click="addNav('structure', '组织架构')">
            <span><i class="el-icon-grape"></i>组织架构</span>
          </el-menu-item>
        </el-menu>
      </el-aside>
      <el-container>
              ...
              <div>
                ...
                <el-dropdown>
                  ...
                  <el-dropdown-menu slot="dropdown">
                    <div><el-button size="mini">首页</el-button></div>
                    <div><el-button size="mini">项目地址</el-button></div>
                    <div><el-button size="mini" @click="loginOut">退出登录</el-button></div>
                  </el-dropdown-menu>
                </el-dropdown>
              </div>
            </div>
