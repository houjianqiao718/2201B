<template>
  <div>
    ...
    <el-card>
      ...
      <el-table :data="orderList" border stripe>
        ...
        <el-table-column label="操作">
          <template slot>
            <el-button type="primary" size="mini" icon="el-icon-edit" @click="EditDialogVisible"></el-button>
    ...
    <!-- 编辑对话框 -->
		<editOrder v-if="addressDialogVisible" ref="OrderEdit" />
    <!-- 展示物流进度对话框 -->
		<OrderPropress v-if="progressDialogVisible" ref="OrderPropress" />
  </div>
</template>

<script>
import cityData from "./citydata"
import editOrder from "./OrderEdit.vue"
import OrderPropress from "./OrderPropress.vue"

export default {
  components: { OrderPropress, editOrder },
  data() {
    return {
      // 订单列表查询参数
      queryInfo: {
