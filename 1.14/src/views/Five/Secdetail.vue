      ...
      <div class="box">
        ...
        <div class="right">
          ...
          <div class="con">
            ...
            <span class="span"
              >入职时间：<span>{{ userInfo.timeOfEntry ? userInfo.timeOfEntry.slice(0, 10) : "" }}</span></span
            >
            <span class="span"
          ...
          <div class="foot">
            <span
              >本月不缴纳社保 <el-switch v-model="value" active-color="#13ce66" inactive-color="#ff4949"> </el-switch
            ></span>
            <span
              >本月不缴纳公积金 <el-switch v-model="value1" active-color="#13ce66" inactive-color="#ff4949"> </el-switch
            ></span>
          </div>
        </div>
      </div>
